...
ActiveRecord::Schema.define(version: 20170615232212) do
  ...
  create_table "stores", force: :cascade do |t|
    ...
    t.string "name"
    t.integer "planet_id"
    t.integer "narcotics_price"
    t.integer "scrap_metal_price"
    t.integer "medicine_price"
    t.integer "grain_price"
    t.integer "gold_price"
    t.integer "plastic_price"
    t.integer "diamonds_price"
    t.integer "missiles_price"
    t.integer "bananas_price"
    t.integer "uranium_price"
    t.integer "tang_price"
    t.integer "potatoes_price"
    t.integer "furs_price"
    t.integer "steel_price"
